---
title: Character Tickets for Beginners
description: Learn the difference between Gold, Roll Tickets, Character Tickets, and rental access before choosing an unlock.
category: unlock
tags:
  - character-ticket
  - gold
...
patchReviewed: null
sourceUrls:
  - https://ultrarumble.com/guide?file=miscellaneous.md
...
1. Open the Event or Mission area and complete the available Beginner Missions.
2. Check the Special Missions tied to Research Notebook progress.
3. Claim completed rewards instead of assuming they are delivered automatically.
4. Return to the character screen and inspect which characters currently accept the ticket.
